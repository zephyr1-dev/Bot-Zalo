...
![JavaScript](https://img.shields.io/badge/JavaScript-93.4%25-yellow?style=flat-square&logo=javascript)
...
- 🎙️ Nhắc nhở theo mô-tả (scold)
- Hỗ trợ mention thành viên

### 🔐 Bảo Mật & Cảnh Báo
- ⚠️ Cảnh cáo người dùng (warn)
- 📋 Danh sách cảnh cáo
...
#### 2. **IMEI**
- Đăng nhập **Zalo Web**: https://web.zalo.me/
...
- 🗄️ Schema Database: `bot-zalo-hahuyhoang.sql`
- ⚙️ Cấu hình nhóm: `groupSettings.json`
...
> ⚠️ **QUAN TRỌNG**: Bot được phát triển cho mục đích **quản lý và bảo vệ nhóm Zalo**. Vui lòng sử dụng **có trách nhiệm** và tuân thủ các quy tắc của Zalo.
