# Dũng Zalo ChatBot Project  
# Nodejs 20  

This Zalo ChatBot project is developed using JavaScript with the **zlbotdqt** library. The creator of this project is **Dũng**. You can find more information at [Dũng's GitHub](https://github.com/duong) *(or your own link)*.  
...
---  
*Project maintained by **Dũng** – all rights reserved.* 
