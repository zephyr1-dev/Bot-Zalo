...
function getModelConfig(models) {
    var config = {};
...
var getModelJson = function (modelName, availableModels) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!model) {
                    throw new Error("Model '".concat(modelName, "' was not found in the provided models registry."));
                }
                return [4, model.modelJson()];
            case 1: return [2, (_a.sent()).default];
        }
    });
}); };
var getWeightData = function (modelName, availableModels) { return __awaiter(void 0, void 0, void 0, function () {
    var model, numOfWeightBundles, weightBundles, bundles, i, bundleName, identifier, globalWeight, weightBundle, weight;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                numOfWeightBundles = model.numOfWeightBundles, weightBundles = model.weightBundles;
                bundles = [];
                i = 0;
                _c.label = 1;
            case 1:
                if (!(i < numOfWeightBundles)) return [3, 5];
                ...
                return [3, 4];
            case 2:
                weightBundle = weightBundles[i];
                if (!weightBundle) {
                    throw new Error("Could not find a weight bundle loader for '".concat(modelName, "' at index ").concat(i, "."));
                }
                return [4, weightBundle()];
            case 3:
            ...
            case 4:
                i++;
                return [3, 1];
            case 5: return [2, Object.assign.apply(Object, __spreadArray([{}], bundles, false))];
        }
    });
}); };
function loadWeights(modelName, availableModels) {
    return __awaiter(this, void 0, void 0, function () {
        var weightDataBundles, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4, getWeightData(modelName, availableModels)];
                case 1:
                    weightDataBundles = _a.sent();
                    return [2, weightDataBundles];
                case 2:
                    error_1 = _a.sent();
                    if (error_1 instanceof Error && /provided models registry/.test(error_1.message)) {
                        throw error_1;
                    }
...
function loadModel(modelName, availableModels) {
    return __awaiter(this, void 0, void 0, function () {
        var modelJson, weightData, handler, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4, getModelJson(modelName, availableModels)];
                case 2:
                    modelJson = _a.sent();
                    return [4, loadWeights(modelName, availableModels)];
                case 3:
                    weightData = _a.sent();
                ...
                case 4:
                    error_2 = _a.sent();
                    if (error_2 instanceof Error && /provided models registry/.test(error_2.message)) {
                        throw error_2;
                    }
...
function load(modelOrUrl_1) {
    return __awaiter(this, arguments, void 0, function (modelOrUrl, options) {
        var availableModels, model, modelUrlOrHandler, nsfwnet;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    availableModels = getModelConfig(options.modelDefinitions || []);
                    if (isModelName(modelOrUrl)) {
                        ...
                        model = availableModels[modelOrUrl];
                        if (model === null || model === void 0 ? void 0 : model.options) {
                            options = __assign(__assign({}, options), model.options);
                        }
                    }
                    options.size = (options === null || options === void 0 ? void 0 : options.size) || IMAGE_SIZE;
                    return [4, loadModel(modelOrUrl, availableModels)];
                case 1:
                    modelUrlOrHandler = _a.sent();
...
var NSFWJS = (function () {
    ...
    NSFWJS.prototype.dispose = function () {
        if (this.disposed) {
            return;
        }
        Object.values(this.intermediateModels).forEach(function (intermediateModel) {
